      ...
      {fullWidth &&
        (close ? (
          ...
          >
            ...
            >
              <path
                d="M8.74865 11.0526H6.64355V11.9882H8.74865V11.0526Z"
                fill="#ABABAB"
              />
              <path
                d="M11.041 10.0928V10.5606C11.041 10.832 10.8202 11.0528 10.5488 11.0528H10.0811V11.9884H10.5488C11.3362 11.9884 11.9766 11.3479 11.9766 10.5606V10.0928H11.041Z"
                fill="#ABABAB"
              />
              <path
                d="M5.33459 0.0115967H3.22949V0.947204H5.33459V0.0115967Z"
                fill="#ABABAB"
              />
              <path
                d="M8.74865 0.0115967H6.64355V0.947204H8.74865V0.0115967Z"
                fill="#ABABAB"
              />
              <path
                d="M1.42877 0.0115967C0.641457 0.0115967 0.000976562 0.6521 0.000976562 1.43939V1.90719H0.936584V1.43939C0.936584 1.16799 1.15739 0.947204 1.42877 0.947204H1.89657V0.0115967H1.42877Z"
                fill="#ABABAB"
              />
              <path
                d="M10.5488 0.0115967H10.0811V0.947204H10.5488C10.8203 0.947204 11.041 1.16801 11.041 1.43939V1.90719H11.9766V1.43939C11.9766 0.6521 11.3362 0.0115967 10.5488 0.0115967Z"
                fill="#ABABAB"
              />
              <path
                d="M0.935607 3.3573H0V5.4624H0.935607V3.3573Z"
                fill="#ABABAB"
              />
              <path
                d="M12.0001 6.77136H11.0645V8.87646H12.0001V6.77136Z"
                fill="#ABABAB"
              />
              <path
                d="M12.0001 3.3573H11.0645V5.4624H12.0001V3.3573Z"
                fill="#ABABAB"
              />
              <path
                d="M6.19932 2.42188V3.35746H8.02701L4.94208 6.58063C4.72907 6.45013 4.47876 6.37477 4.21117 6.37477H1.40438C0.630535 6.37477 0.000976562 7.00433 0.000976562 7.77817V10.585C0.000976562 11.3588 0.630535 11.9884 1.40438 11.9884H4.21117C4.98501 11.9884 5.61457 11.3588 5.61457 10.585V7.77817C5.61457 7.61549 5.58642 7.45935 5.53531 7.31392L8.65528 4.05414V5.81339H9.59088V2.42188H6.19932ZM4.67896 10.5849C4.67896 10.8429 4.4691 11.0527 4.21117 11.0527H1.40438C1.14642 11.0527 0.936584 10.8429 0.936584 10.5849V7.77815C0.936584 7.52019 1.14644 7.31036 1.40438 7.31036H4.21117C4.46913 7.31036 4.67896 7.52022 4.67896 7.77815V10.5849Z"
                fill="#ABABAB"
              />
            </svg>

            <p style={{ fontWeight: 400, fontSize: 8, color: "#ABABAB" }}>
              Развернуть видео
            </p>
          </div>
        ) : (
